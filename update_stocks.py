...
CI_STOCKS = [
    {"ticker": "COH.AX",    "name": "Cochlear Limited",   "currency": "AUD", "exchange": "ASX",               "ciCompany": "Cochlear Ltd",             "role": "Direct"},
    {"ticker": "SONVF",     "name": "Sonova Holding AG",  "currency": "USD", "exchange": "OTC",               "ciCompany": "Sonova / Advanced Bionics", "role": "Parent"},
    {"ticker": "DEMANT.CO", "name": "Demant A/S",         "currency": "DKK", "exchange": "Nasdaq Copenhagen", "ciCompany": "Demant / Oticon Medical",   "role": "Parent"},
]
...
with open("/home/user/workspace/ci-dashboard/stocks.json", "w") as f:
    json.dump(payload, f)
